...
const menuItems: MenuSection[] = [
  ...
  // «Сделки (CRM)» временно скрыт из меню у ВСЕХ ролей по просьбе заказчика —
  // раздел дорабатывается. Страница /dashboard/crm остаётся, просто не выводится
  // в навигацию. Чтобы вернуть — раскомментировать и восстановить редирект
  // после логина в login-form.tsx.
  // {
  //   title: "Сделки (CRM)",
  //   icon: Briefcase,
  //   url: "/dashboard/crm",
  ...
  // СКРЫТО из меню (просьба заказчика). Страница /dashboard/favorites и звёздочка
  // в карточке квартиры остаются рабочими. Чтобы вернуть пункт в меню — вернуть
  ...
  // человек.
  // ВРЕМЕННО СКРЫТО из меню (раздел ещё дорабатывается) — вернём, когда заработает.
  // Чтобы вернуть — восстановить roles: ["ADMIN", "BROKER", "COORDINATOR", "ANALYST"].
  {
